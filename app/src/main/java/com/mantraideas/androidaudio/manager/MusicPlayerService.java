...
import com.mantraideas.androidaudio.MainActivity;
import com.mantraideas.androidaudio.MyApplication;
import com.mantraideas.androidaudio.R;
...
public class MusicPlayerService extends Service implements AudioManager.OnAudioFocusChangeListener, NotificationManager.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "com.rowsun.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "com.rowsun.musicplayer.close";
    public static final String NOTIFY_PAUSE = "com.rowsun.musicplayer.pause";
    public static final String NOTIFY_PLAY = "com.rowsun.musicplayer.play";
    public static final String NOTIFY_NEXT = "com.rowsun.musicplayer.next";
